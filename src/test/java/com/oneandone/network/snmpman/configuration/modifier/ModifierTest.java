...
public class ModifierTest {
    ...
    public void testIsApplicable() throws Exception {        
        final Modifier modifier = new Modifier(".1.3.6.*", "com.oneandone.network.snmpman.configuration.modifier.Counter32Modifier", new ModifierProperties());
    ...
    public void testModify() throws Exception {
        ...
        final Modifier modifier = new Modifier(".1.3.6.*", "com.oneandone.network.snmpman.configuration.modifier.Counter32Modifier", modifierProperties);
